...
## 2.2 Pull Aupera Face Recognition Docker Image
...
+ Choose suitable License configuration file ( Either Floating License or Nodelocked License ) & copy to `{NFS_ABS_PATH}/drm` path  
